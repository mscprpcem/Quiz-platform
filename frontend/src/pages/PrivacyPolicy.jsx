      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="bg-white border border-brand-border rounded-2xl p-6 sm:p-8 shadow-soft text-left space-y-6 relative overflow-hidden">
          ...
          <div className="space-y-2 relative z-10">
            ...
            <h1 className="text-2xl sm:text-3xl font-black text-slate-800 tracking-tight">Privacy Policy</h1>
          ...
          <div className="p-4 bg-slate-50/50 border border-slate-100 rounded-xl">
            <p className="text-xs sm:text-sm font-semibold text-slate-700 italic leading-relaxed">
              How we collect, manage, and safeguard student developer data under MSC regulations.
            </p>
          </div>

          <div className="text-xs sm:text-sm text-slate-600 leading-relaxed font-medium space-y-6">
            <section className="space-y-2">
              <h3 className="font-extrabold text-sm sm:text-base text-slate-800">1. Data Minimization</h3>
              <p>
                We collect only minimal essential data, such as participant names, official campus roll numbers, department streams, and registered email IDs. No third-party data collection trackers are integrated.
              </p>
            </section>

            <section className="space-y-2">
              <h3 className="font-extrabold text-sm sm:text-base text-slate-800">2. Active Quiz Sessions</h3>
              <p>
                Live quiz data, including question attempts, completion durations, and tab switch focus events, is stored to compile real-time leaderboard statistics.
              </p>
            </section>

            <section className="space-y-2">
              <h3 className="font-extrabold text-sm sm:text-base text-slate-800">3. Third-Party Sharing</h3>
              <p>
                We do not sell or lease student details to any third-party databases. All verification records are held securely on Azure-hosted databases.
              </p>
            </section>
