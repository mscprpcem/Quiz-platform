        ...
        <div className="bg-white border border-brand-border rounded-2xl p-6 sm:p-8 shadow-soft text-left space-y-6 relative overflow-hidden">
          ...
          <div className="space-y-2 relative z-10">
            <div className="inline-flex items-center gap-2 text-brand-blue bg-brand-lightBlue px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider">
              <Bug size={12} className="stroke-[3]" />
              <span>Resources</span>
            </div>
            <h1 className="text-2xl sm:text-3xl font-black text-slate-800 tracking-tight">Report Issue</h1>
          ...
          <div className="p-4 bg-slate-50/50 border border-slate-100 rounded-xl">
            <p className="text-xs sm:text-sm font-semibold text-slate-700 italic leading-relaxed">
              Guidelines for reporting bugs, platform latency, and score validation failures.
            </p>
          </div>
          ...
          <div className="text-xs sm:text-sm text-slate-600 leading-relaxed font-medium space-y-6">
            ...
            <section className="space-y-2">
              <h3 className="font-extrabold text-sm sm:text-base text-slate-800">2. Required Diagnostics</h3>
              <p>
                Provide device type/browser details and screenshots. Attach console errors if possible to help speed up troubleshooting.
              </p>
            </section>

            <section className="space-y-2">
              <h3 className="font-extrabold text-sm sm:text-base text-slate-800">3. Exploit Disclosures</h3>
              <p>
                If you discover a security vulnerability or grading system exploit, please report it privately to lead organizers to avoid student integrity flags.
              </p>
            </section>
          </div>
