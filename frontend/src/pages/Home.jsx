...
export default function Home() {
  ...
  return (
    <div className="min-h-[calc(100vh-60px)] flex flex-col justify-center py-10 sm:py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto w-full space-y-14 sm:space-y-20 animate-fade-in relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center pt-4">
          ...
          <div className="lg:col-span-7 space-y-6 sm:space-y-7 text-left">
            ...
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold text-zinc-900 tracking-tight leading-tight lg:leading-[1.1]">
              Real-Time Quiz &{' '}
            ...
            <div className="flex flex-col xs:flex-row flex-wrap gap-3 pt-1">
              ...
              <button
                ...
                className="flex items-center justify-center space-x-2 bg-white hover:bg-zinc-50 text-zinc-600 hover:text-zinc-800 font-semibold py-3 px-6 rounded-xl border border-zinc-200 hover:border-zinc-300 transition-all duration-200 active:scale-[0.97] shadow-sm cursor-pointer text-sm"
              >
          ...
          <div className="lg:col-span-5 w-full">
            <div className="bg-white border border-zinc-200/85 p-6 sm:p-8 rounded-2xl shadow-soft space-y-6 relative overflow-hidden group hover:shadow-soft-lg transition-shadow duration-300">
              ...
              <div className="space-y-1.5">
                <h3 className="text-lg sm:text-xl font-bold text-zinc-800 tracking-tight">Quick Join Session</h3>
                <p className="text-xs sm:text-sm text-zinc-400">Got an active event code? Join immediately below.</p>
              </div>
              ...
              <form onSubmit={handleQuickJoinSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full flex items-center justify-center space-x-2 bg-gradient-to-b from-[#0A84FF] to-[#0068D6] hover:from-[#007AE6] hover:to-[#005FC0] text-white font-semibold py-3.5 rounded-xl transition-all duration-200 active:scale-[0.97] shadow-md hover:shadow-lg cursor-pointer text-sm"
                >
        ...
        <div className="space-y-6 sm:space-y-8">
          <div className="text-center space-y-2.5">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-zinc-900 tracking-tight">Choose Your Quiz Mode</h2>
            <p className="text-zinc-500 text-sm max-w-lg mx-auto">Explore multiplayer active competition or test your skills at your own pace.</p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
            {/* Mode 1: Live Event */}
            <div className="bg-white border border-zinc-200/80 hover:border-microsoft-blue/30 rounded-2xl p-5 sm:p-6 shadow-sm hover:shadow-soft-lg transition-all duration-300 flex flex-col justify-between text-left group">
              <div className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <h3 className="text-base sm:text-lg font-bold text-zinc-800 mt-1.5">Live Sync Events</h3>
            ...
            {/* Mode 3: Challenges */}
            <div className="bg-white border border-zinc-200/80 rounded-2xl p-5 sm:p-6 shadow-sm text-left flex flex-col justify-between opacity-75 select-none sm:col-span-2 lg:col-span-1">
              <div className="space-y-4">
                ...
                <div className="space-y-1.5">
                  <span className="text-[9px] font-bold text-purple-500 uppercase tracking-widest bg-purple-50 px-2.5 py-0.5 rounded-full">Coming Soon</span>
                  <h3 className="text-base sm:text-lg font-bold text-zinc-800 mt-1.5">Skill Challenges</h3>
                  <p className="text-xs text-zinc-500 leading-relaxed mt-1">
        ...
        {/* Feature Cards Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 text-left border-t border-zinc-150 pt-10 sm:pt-12 pb-4">
          {/* Card 1 */}
