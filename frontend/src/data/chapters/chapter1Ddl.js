...
export const CHAPTER_1_TOPICS = {
  'top-create-table': {
    ...
    infographicImage: 'https://mscprpcem.blob.core.windows.net/quiz/how-create-table-works.jpg',
    infographicTitle: 'How CREATE TABLE Works in SQL',
    infographicCaption: 'Executing CREATE TABLE instructs the database engine to construct a clean, typed table structure ready to store data rows.',
    underTheHood: {
  ...
  'top-alter-table': {
    ...
    infographicImage: 'https://mscprpcem.blob.core.windows.net/quiz/how-alter-table-works.jpg',
    infographicTitle: 'How ALTER TABLE Modifies Table Structure',
    infographicCaption: 'Notice how ALTER TABLE adds a new column directly into an existing table without destroying or losing existing rows.',
    underTheHood: {
...
RENAME TABLE 
  ...
  'top-truncate-table': {
    ...
    infographicImage: 'https://mscprpcem.blob.core.windows.net/quiz/drop-vs-truncate-vs-delete.jpg',
    infographicTitle: 'Visual Comparison: DROP vs TRUNCATE vs DELETE',
    infographicCaption: 'Notice the core difference: DROP completely erases the table, TRUNCATE clears all rows while preserving table structure, and DELETE removes specific rows.',
    underTheHood: {
