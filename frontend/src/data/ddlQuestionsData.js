// =========================================================================
// 📘 50 DDL PRACTICE QUESTIONS DATA (SECTIONS A TO J)
// =========================================================================
...
export const DDL_SECTIONS = [
  ...
  { id: 'SECTION A', label: 'A: CREATE', count: 5 },
  { id: 'SECTION B', label: 'B: ADD COL', count: 5 },
  { id: 'SECTION C', label: 'C: MODIFY', count: 5 },
  { id: 'SECTION D', label: 'D: RENAME COL', count: 5 },
  { id: 'SECTION E', label: 'E: DROP COL', count: 5 },
