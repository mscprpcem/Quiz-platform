  ...
  try {
    ...
    const columns = [
      ...
      `CREATE TABLE IF NOT EXISTS ${quote}Events${quote} (
        ...
        ${quote}is_registration_open${quote} ${boolType} DEFAULT 1,
      ...
      `ALTER TABLE ${quote}Events${quote} ADD COLUMN ${ifNotExists}${quote}is_registration_open${quote} ${boolType} DEFAULT 1;`,
      ...
      ...(isPostgres ? [
        `CREATE TABLE IF NOT EXISTS events (
          ...
          start_date ${dateType},
          end_date ${dateType},
          registration_start_date ${dateType},
          registration_end_date ${dateType},
          max_registrations INTEGER,
          fee VARCHAR(255) DEFAULT 'Free',
          is_registration_open ${boolType} DEFAULT true,
          rewards VARCHAR(255),
        ...
        `ALTER TABLE events ADD COLUMN IF NOT EXISTS start_date ${dateType};`,
        `ALTER TABLE events ADD COLUMN IF NOT EXISTS end_date ${dateType};`,
        `ALTER TABLE events ADD COLUMN IF NOT EXISTS registration_start_date ${dateType};`,
        `ALTER TABLE events ADD COLUMN IF NOT EXISTS registration_end_date ${dateType};`,
        `ALTER TABLE events ADD COLUMN IF NOT EXISTS max_registrations INTEGER;`,
        `ALTER TABLE events ADD COLUMN IF NOT EXISTS fee VARCHAR(255) DEFAULT 'Free';`,
        `ALTER TABLE events ADD COLUMN IF NOT EXISTS is_registration_open ${boolType} DEFAULT true;`,
